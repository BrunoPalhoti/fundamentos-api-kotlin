package com.isadora.bank.controller

import com.isadora.bank.model.Account
import com.isadora.bank.model.dto.AccountDto
import com.isadora.bank.repository.AccountRepository
...
class AccountController(private val repository: AccountRepository) {
    ...
    @PutMapping("/{id}")
    fun update(@PathVariable id : Long, @RequestBody account: AccountDto) : ResponseEntity<Account> =
        repository.findById(id).map {
